...
export enum IO_Port {
    ...
    //CHUNGUS custom IO
        ...
        PI1, PI2,
        //block RAM
        BLOCKRAM_XY, BLOCKRAM_ZI, BLOCKRAM_ID, BLOCKRAM_ZI_SET,
        //blockToMesh
        ...
        //AMOGUS
        AMOGUS_CAMX = MESHGEN_SETTINGS + 1, AMOGUS_CAMY, AMOGUS_CAMZ, AMOGUS_CAMROT,
        AMOGUS_VERTX, AMOGUS_VERTY, AMOGUS_VERTZ, AMOGUS_VERTUV, AMOGUS_TEX, AMOGUS_SETTINGS,
        AMOGUS_DRAWTOSCREEN = AMOGUS_SETTINGS,
