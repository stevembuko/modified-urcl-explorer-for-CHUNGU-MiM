...
export enum IO_Port {
    ...
    //CHUNGUS custom IO
        ...
        PI1, PI2,
        //block RAM
        BLOCKRAM_XY, BLOCKRAM_ZI, BLOCKRAM_ID = IO_Port.BLOCKRAM_XY, BLOCKRAM_SETID = BLOCKRAM_ZI + 1,
        //blockToMesh
        MESHGEN_XY, MESHGEN_ZI, MESHGEN_BREAKPHASE, MESHGEN_ITEMXY, MESHGEN_ITEMZI,
        MESHGEN_RENDERITEM, MESHGEN_RENDERBLOCK, MESHGEN_RENDERSCENE,
        //AMOGUS
        AMOGUS_CAMX, AMOGUS_CAMY, AMOGUS_CAMZ, AMOGUS_CAMROT,
        AMOGUS_VERTX, AMOGUS_VERTY, AMOGUS_VERTZ, AMOGUS_VERTUV, AMOGUS_TEX, AMOGUS_SETTINGS,
        AMOGUS_CAMDIRX, AMOGUS_CAMDIRY, AMOGUS_CAMDIRZ,
        AMOGUS_SUBMITVERT, AMOGUS_DRAWQUAD, AMOGUS_CLEARBUFFER, AMOGUS_DRAWTOSCREEN = AMOGUS_SETTINGS,
